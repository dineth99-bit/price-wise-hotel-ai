...
const RevenueImpactAnalysis: React.FC<RevenueImpactAnalysisProps> = ({ open, onOpenChange }) => {
  // Calculate detailed revenue impact metrics
  const calculateDetailedImpact = () => {
    ...
    while (currentDate <= today) {
      ...
      // Actual revenue with some variance
    ...
    const projectedVsActualPct = (projectedVsActual / totalProjectedRevenue) * 100;
    const avgDailyImpact = projectedVsActual / dayCount;
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Projected vs Optimized vs Actual revenue from May 15 - June 15, 2025
              </CardDescription>
            </CardHeader>
            <CardContent>
              <RevenueImpactChart />
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  ...
                  <li>• Performance tracked over {metrics.dayCount} days (May 15-28, 2025)</li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-bold">May 15 - May 28, 2025</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm">Projection Period:</span>
                    <span className="text-sm font-bold">Until June 15, 2025</span>
                  </div>
                </div>
              </CardContent>
            </Card>
